...
const Project = props => {
    ...
    return (
        ...
        <div className={classes.container}>
            ...
            <Content mobile_description={props.mobile_description} project_type={props.project_type} color={{color:`rgb(${props.rgb})`}} images={props.images} thumbnail_desc={props.thumbnail_desc} thumbnail_name={props.thumbnail_name} tech_used={props.tech_used} active_section={active_section} thumbnail_clipping={props.thumbnail_clipping}/>
